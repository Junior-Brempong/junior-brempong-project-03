...
const useFirestore = (collection) => {
    ...
    useEffect(() => {
        ...
        // We can create unsub to store this function which will be used to unsubscribe from the collection/ That means if we DON'T want to listen to the collection, we can invoke this method
